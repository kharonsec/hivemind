...
mkdir -p src test docs/hivemind/plans

# Create a simple implementation plan
cat > docs/hivemind/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/hivemind/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from hivemind directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/hivemind/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"hivemind:subagent-driven-development"' "$SESSION_FILE"; then
