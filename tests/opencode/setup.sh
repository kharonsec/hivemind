...
mkdir -p "$HOME/.config/opencode/hivemind"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/hivemind/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/hivemind/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/hivemind/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/hivemind.js" "$HOME/.config/opencode/hivemind/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/hivemind/.opencode/plugins/hivemind.js" \
       "$HOME/.config/opencode/plugins/hivemind.js"
...
echo "Plugin installed to: $HOME/.config/opencode/hivemind/.opencode/plugins/hivemind.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/hivemind.js"
