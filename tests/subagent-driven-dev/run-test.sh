...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/hivemind
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/hivemind-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using hivemind:subagent-driven-development. The plan is at: $PLAN_PATH"
